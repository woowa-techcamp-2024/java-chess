...
public class Main {
    ...
    public Main(){
        ...
        gameInputView = new ConsoleInputView();
        gameOutputView = new ConsoleOutputView();
        gameView = new ConsoleGameView(gameInputView, gameOutputView);
        gameManager = new ConsoleGameManager(gameView,chessGame);
