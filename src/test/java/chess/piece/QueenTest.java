...
class QueenTest {
    ...
    public void move_piece() {
        PieceMove whiteMove =Queen.create(PieceColor.WHITE).getMoveable();
        PieceMove blackMove = Queen.create(PieceColor.BLACK).getMoveable();
