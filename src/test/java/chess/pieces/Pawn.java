...
public class Pawn extends Piece {
    ...
    public List<List<Position>> getPossibleMoves(Position currentPosition) {
        ...
        if (Color.BLACK == getColor()) {
            if (currentPosition.getRow() == 2) possibleMoves.add(getPossibleMovesOfDirection(currentPosition, Direction.DOWN, 2));
            else possibleMoves.add(getPossibleMovesOfDirection(currentPosition, Direction.DOWN, 1));
        ...
        if (Color.WHITE == getColor()) {
            if (currentPosition.getRow() == 6) possibleMoves.add(getPossibleMovesOfDirection(currentPosition, Direction.UP, 2));
            else possibleMoves.add(getPossibleMovesOfDirection(currentPosition, Direction.UP, 1));
